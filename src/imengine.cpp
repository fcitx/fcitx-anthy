...
#define ACTION_CONFIG_SELECT_NEXT_CANDIDATE_ALTER_KEY   "SelectNextCandidateKeyAlter"
#define ACTION_CONFIG_SELECT_PREV_CANDIDATE_ALTER_KEY   "SelectPrevCandidateKeyAlter"
...
CONFIG_BINDING_REGISTER("Key", ACTION_CONFIG_SELECT_NEXT_CANDIDATE_ALTER_KEY, m_key_default.m_hk_SELECT_NEXT_CANDIDATE_ALTER)
CONFIG_BINDING_REGISTER("Key", ACTION_CONFIG_SELECT_PREV_CANDIDATE_ALTER_KEY, m_key_default.m_hk_SELECT_PREV_CANDIDATE_ALTER)
...
void AnthyInstance::configure()
{
    ...
    APPEND_ACTION (SELECT_NEXT_CANDIDATE_ALTER,   action_select_next_candidate);
    APPEND_ACTION (SELECT_PREV_CANDIDATE_ALTER,   action_select_prev_candidate);
